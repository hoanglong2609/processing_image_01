...
const ResetPassword = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text className="text-[28px] font-semibold text-[#413f52]">Forgot password</Text>
      <TextInput
